...
if __name__ == '__main__':
    ...
    argParser.add_argument("-p","--object_count",          help = "object count for exp",                 nargs="?",default=1)
    ...
    argParser.add_argument("-o","--order_object_placement",help = "set to remove random order of objects",action="store_true")
    ...
    argParser.add_argument(     "--prefix",                help = "prefix to use",                        nargs='?',default=None)
    ...
    success_bool, kplans, plan_lengths, learnt_actions, learnt_relations, traj_config, time_dict, latest_model_num = tg.lamp_start(execute=execute,
                                                                                                                                   generate=get_graph,
                                                                                                                                   config=goal_pairs,
    ...
    log_dict["num demonstrations"] = total_traj_count

    for key in time_dict:
        log_dict[key] = time_dict[key]
    
    log(log_dict,log_num,prefix=prefix,key=problem_num,demonstration_count=total_traj_count,seed2=seed2)