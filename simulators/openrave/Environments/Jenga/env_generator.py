...
class environment():    
    def __init__(self,env_name=None,interactive=False):
        ...
        if env_name is not None:
            if interactive:
                ...
                self.env.Load('/workspaces/H-RCR/Environments/Jenga/reference_structure/{}.dae'.format(env_name[0]))
            else:
    ...
    def load_plank(self):
        self.env.Load("/workspaces/H-RCR/Environments/Jenga/objects/jenga.dae")
