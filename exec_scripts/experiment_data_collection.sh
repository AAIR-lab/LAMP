...
declare -A total_traj_percent_dict=( ["Keva"]=1.0 ["CafeWorld"]=0.125 ["Packing"]=0.4 )
array3=()
...
declare -A mother_pool=( ["Keva"]=160 ["CafeWorld"]=1600 ["Packing"]=500 )
