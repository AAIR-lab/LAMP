...
class ClearPredicate(object):
    ...
    def __str__(self):
        if self.parameter == "":
            ...
            if parameter_str:
                if self.parameter.split("_")[Config.OBJ_TYPE_IND] in Config.CONST_TYPES:
                    parameter_str = "{}_{}_Const".format(*self.parameter.split("_")[:Config.OBJ_ID_IND])
    ...
    def __deepcopy__(self,memodict={}):
        new_const_relation = ClearPredicate(self.parameter1_type, self.parameter2_type, self.cr, self.id,self.parameter)
