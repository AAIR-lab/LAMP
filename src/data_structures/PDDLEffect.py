...
class LiftedPDDLEffect(object):
    ...
    def get_grounded_effect(self,grounding,ll_state_object_list): 
        add_set = set()
        delete_set = set() 
        for prop in self.add_set: 
            add_set.add(prop.ground_relation(grounding,ll_state_object_list))
        for prop in self.delete_set: 
            delete_set.add(prop.ground_relation(grounding,ll_state_object_list))
