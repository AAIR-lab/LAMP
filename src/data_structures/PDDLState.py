...
class PDDLState(object):
    def __init__(self,true_set,false_set,aux_true_set,aux_false_set,ll_state_index=(-1,-1,-1)): 
        self.true_set = true_set
        self.false_set = false_set
        self.aux_true_set = aux_true_set
        self.aux_false_set = aux_false_set
        self.ll_state_index = ll_state_index
    ...
    @staticmethod
    def get_from_ll(lifted_relations_dict, object_dict, ll_state, aux_list,ll_state_index=(-1,-1,-1)):
        true_set = set()
        false_set = set()
        aux_true_set = set()
        ...
        for object_pair in lifted_relations_dict: 
            for cr in lifted_relations_dict[object_pair]: 
                ...
                for combination in combinations:
                    grounded_relation = relation.get_grounded_relation(combination[0],combination[1],ll_state.object_dict.keys())
        ...
        return PDDLState(true_set,false_set,aux_true_set,set(),ll_state_index)
    ...
    def __deepcopy__(self,memodict={}):
        new_pddl_state = PDDLState(self.true_set,self.false_set,self.aux_true_set,self.aux_false_set,self.ll_state_index)
