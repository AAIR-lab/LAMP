...
if __name__ == '__main__':
    ...
    argParser.add_argument("--prefix",                 help = "prefix to fix",                          nargs='?',default=0)
    ...
    argParser.add_argument("-v","--visualize",                help = "print the regions",                    action="store_true")
    ...
    if args.total_traj_count is not None:
        total_traj_count = float(args.total_traj_count)
    else:
        total_traj_count = 0
